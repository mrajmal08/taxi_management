    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.maintainers.create") }}">
                {{ trans('global.add') }} {{ trans('cruds.maintainers.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.maintainers.title_singular') }} {{ trans('global.list') }}
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-ExpenseCategory">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.maintainers.fields.id') }}
                        </th>
                        <th>
                            {{ trans('cruds.maintainers.fields.name') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
